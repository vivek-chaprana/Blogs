...
export async function ReportBlogEmailTemplate({
  reportedBy,
  blogId,
  reason,
  other,
  ...
  const blogDetails = await prisma.blogPost.findUnique({
    where: {
      id: blogId,
    },
    select: {
                        ...
                        <tr>
                          <td class="sm-px-6" style="padding: 40px">
                            <table style="width: 100%" cellpadding="0" cellspacing="0" role="presentation">
                              <tr>
                                <td>
                                  <h1 class="dark-text-gray-50"
                                    ...
                                    We recieved a new report in ${COMPANY_NAME}
                                  </h1>
                                  ...
                                  <p class="dark-text-gray-50"
                                    ...
                                    Please check the report and take necessary action. Below are the details of the report.
                                    <br>
                                    <br>
                                    ...
                                    <br>
                                    <strong>Reported At:</strong> ${currentTime}
                                    <br>
                              ...
                              <tr>
                                <td>
                                  <a href="${`${WEBAPP_URL}/${blogDetails.author.username}/${blogDetails.slug}`}"
                                    ...
                                    <!--[if mso
                                        ...
                                        >&nbsp;</i><!
                                    [endif]-->
                                    <span style="mso-text-raise: 15px">View blog</span>
                                    <!--[if mso
                                      ]><i
                                        style="
                                          letter-spacing: 24px;
                                  ...
                                  <div>
                                    <h4 style="margin-bottom: 0;">Blog details : </h4>
                                    <p class="dark-text-gray-50"
                                      style="margin: 0; font-size: 16px; line-height: 26px; color: #191847">
                                      Please check the report and take necessary action. Below are the details of the
                                      report.
                                      <br>
                                      <br>
                                      ...
                                      <br>
                                      <strong>Email: </strong> ${
                                        blogDetails.author.email
                                      }
                                      <br>
                                      <strong>Email verified: </strong> ${
                                        blogDetails.author.emailVerified
                                      }
                                      <br>
                                      <strong>Author</strong> <a href="${`${WEBAPP_URL}/${blogDetails.author.username}`}">
                                        ${blogDetails.author.username}
                                      </a>
                                      <br>
                                      <strong>Joined:</strong> ${
                                        blogDetails.author.createdAt
                                      }
                                      <br>
                                    </p>
                                  </div>
...
export async function ReportCommentEmailTemplate({
  reportedBy,
  commentId,
  reason,
  other,
  ...
  const blogDetails = comment?.blogPost;
                          ...
                          <table style="width: 100%" cellpadding="0" cellspacing="0" role="presentation">
                            ...
                            <tr>
                              <td>
                                ...
                                <div>
                                  <h4 style="margin-bottom: 0;">Comment details : </h4>
                                  <p class="dark-text-gray-50"
                                    style="margin: 0; font-size: 16px; line-height: 26px; color: #191847">
                                    ...
                                    <br>
                                    <strong>Author</strong> <a href="${`${WEBAPP_URL}/${comment.author.username}`}">
