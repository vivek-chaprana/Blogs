import { WEBAPP_URL, COMPANY_NAME } from "@/lib/constants";
...
export default function ResetPasswordEmail({
  ...
  const accountUrl = `${WEBAPP_URL}/${username}`;
  return `<!DOCTYPE html>
                          ...
                          <tr>
                              <td style="vertical-align: top" valign="top">
                                              ...
                                              <td class="sm-px-6" style="padding-left: 40px; padding-right: 40px">
                                                  <table style="width: 100%" cellpadding="0" cellspacing="0"
                                                      ...
                                                      <tr>
                                                          ...
                                                          <td align="right">
                                                              <a href=${accountUrl}
                                                                  class="dark-text-gray-900 dark-bg-gray-50 hover-bg-slate-100"
                                                                  style="text-decoration: none; display: inline-block; border-radius: 8px; background-color: #f9fafb; padding: 7px 12px; text-align: center; font-size: 12px; font-weight: 700; color: #191847; box-shadow: 0px 1px 3px rgba(0, 0, 0, 0.06), 0px 1px 3px rgba(0, 0, 0, 0.1)">
                                                                  <!--[if mso
                                    ]><i
                                      style="
                                        letter-spacing: 24px;
                                  ...
                                  [endif]-->
                                                      ...
                                                      <tr>
                                                          <td>
                                                              ...
                                                              <p class="dark-text-gray-50"
                                                                  ...
                                                                  <br>
                                                                  <br>
                                                                  We use this easy verification step to make sure it's
                                                                  really you. Click the button below to reset your
                                                                  password.
                                                              </p>
                                                          </td>
                                                      </tr>
                                      ...
                                      >&nbsp;</i><!
                                  [endif]-->
                                                                  <span style="mso-text-raise: 15px">Verify</span>
                                                                  <!--[if mso
                                    ]><i
                                      style="
                                        letter-spacing: 24px;
